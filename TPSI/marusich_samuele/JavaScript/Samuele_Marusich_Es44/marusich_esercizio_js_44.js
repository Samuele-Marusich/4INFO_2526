...
describe('ESERCIZIO 44', () => {
    ...
    test('TEST 04', () => {
        expect(JSON.stringify(ordina(
            JSON.parse(fs.readFileSync('esercizio_js_44/input_test04.json', 'utf-8'))
        ))).toBe(
            fs.readFileSync('esercizio_js_44/output_test04-5.json', 'utf-8')
        );
    });
    test('TEST 05', () => {
        expect(JSON.stringify(ordina(
            JSON.parse(fs.readFileSync('esercizio_js_44/input_test05.json', 'utf-8'))
        ))).toBe(
            fs.readFileSync('esercizio_js_44/output_test04-5.json', 'utf-8')
        );
    });
